    ...
    const fetchData = async () => {
      ...
      try {
        const [commentsRes, postsRes, recentRes] = await Promise.all([
          axios.get('https://blog-bliss2.onrender.com/api/user/comments', { headers: { 'auth-token': token } }),
          axios.get('https://blog-bliss2.onrender.com/api/user/posts', { headers: { 'auth-token': token } }),
          axios.get('https://blog-bliss2.onrender.com/api/user/recent-comments', { headers: { 'auth-token': token } }),
        ]);
